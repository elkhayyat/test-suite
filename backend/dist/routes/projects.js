...
// Project team routes
exports.projectRoutes.get('/:id/teams', async (req, res) => {
    try {
...
exports.projectRoutes.post('/:id/teams', async (req, res) => {
    try {
...
exports.projectRoutes.put('/:id/teams/:teamId', async (req, res) => {
    try {
...
exports.projectRoutes.delete('/:id/teams/:teamId', async (req, res) => {
    try {
