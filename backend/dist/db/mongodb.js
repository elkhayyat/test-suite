...
class MongoDB {
    ...
    constructor() {
        ...
        this.collections = {
            flows: this.db.collection('flows'),
            environments: this.db.collection('environments'),
            environmentVariables: this.db.collection('environmentVariables'),
            projects: this.db.collection('projects'),
            folders: this.db.collection('folders'),
            ...
            teamUsers: this.db.collection('teamUsers'),
            projectTeams: this.db.collection('projectTeams'),
        };
    }
    async connect() {
        try {
